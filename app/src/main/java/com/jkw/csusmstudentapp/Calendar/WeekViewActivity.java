package com.jkw.csusmstudentapp.Calendar;
...
public class WeekViewActivity extends AppCompatActivity implements CalendarAdapter.OnItemListener
{
    ...
    private void setWeekView() throws SQLException {
    ...
    public void previousWeekAction(View view) throws SQLException {
        CalendarUtils.selectedDate = CalendarUtils.selectedDate.minusWeeks(1);
        setWeekView();
    }

    public void nextWeekAction(View view) throws SQLException {
        CalendarUtils.selectedDate = CalendarUtils.selectedDate.plusWeeks(1);
        setWeekView();
    }

    @Override
    public void onItemClick(int position, LocalDate date) throws SQLException {
